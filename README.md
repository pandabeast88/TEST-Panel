...
```
bash <(curl -s https://raw.githubusercontent.com/pandabeast88/TEST-Panel/main/setup.sh)
```

## Update
```
bash <(curl -s https://raw.githubusercontent.com/pandabeast88/TEST-Panel/main/update.sh)
```
